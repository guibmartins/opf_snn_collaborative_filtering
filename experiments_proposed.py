...
def main(n_neighbors: int, density='pdf', distance='jaccard', similarity='pearson',
    ...
    # Clustering stage of training samples
    ...
    print("OPF-SNN - Samples per clusters: \n ", np.bincount(clusters))
    ...
    print("CF-OPF - Predicting ratings for test users...")
...
if __name__ == '__main__':
    ...
    for it in range(arg_first_run, arg_n_runs + arg_first_run):
        ...
        cur_path = "/".join([data_dir, "out", arg_dataset, "opf_snn",
        ...
        for k_max in kmax_interval:
            ...
            # for dens in c.DENSITY_FUNCTIONS:
